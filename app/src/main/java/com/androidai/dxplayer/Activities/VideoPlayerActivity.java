...
import com.androidai.dxplayer.adapters.PlaybackIconsAdapter;
import com.androidai.dxplayer.adapters.VideoFilesAdapter;
import com.androidai.dxplayer.models.BrightnessDialog;
import com.androidai.dxplayer.models.IconModel;
import com.androidai.dxplayer.models.MediaFiles;
import com.androidai.dxplayer.models.OnSwipeTouchListener;
import com.androidai.dxplayer.models.PlaylistDialog;
import com.androidai.dxplayer.models.Utility;
import com.androidai.dxplayer.models.VolumeDialog;
...
public class VideoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sp.getString("playback_url", "").isEmpty()){
            ...
            position = 0;
            String url = sp.getString("playback_url", "");
            playVideoOnline(url);
        }
...
//        playError();
    ...
    public void playVideoOnline(String url){
        player = new SimpleExoPlayer.Builder(this).build();
        playerView.setPlayer(player);
